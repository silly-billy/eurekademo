...
public class Generator {
    ...
    public static final String LINK = "jdbc:mysql://127.0.0.1:3306/demo?useUnicode=true&characterEncoding=utf-8";
    ...
    public static void main(String[] args) {
        ...
        PackageConfig packageConfig = new PackageConfig()
                .setParent("com.example.demo.core.dal")
                .setEntity("domain")
                .setMapper("dao")
                .setService("manager")
        ...
        focList.add(new FileOutConfig("/mybatis-templates/xDaoMapper.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/test/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
